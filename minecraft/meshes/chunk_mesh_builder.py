...
def is_void(local_voxel_pos, world_voxel_pos, world_voxels):
    ...
    return voxel_id == 0 or voxel_id == WATER_BLOCK

@njit
def should_render_face(voxel_id, local_voxel_pos, world_voxel_pos, world_voxels):
    neighbor_id = get_voxel_id_at(local_voxel_pos, world_voxel_pos, world_voxels)
    if neighbor_id == 255:
        return False
    if voxel_id == WATER_BLOCK:
        return neighbor_id == 0
    return neighbor_id == 0 or neighbor_id == WATER_BLOCK
    ...
    for x in range(CHUNK_SIZE):
        for y in range(CHUNK_SIZE):
            for z in range(CHUNK_SIZE):
                ...
                wy = y + cy * CHUNK_SIZE
                wz = z + cz * CHUNK_SIZE
                if should_render_face(voxel_id, (x, y + 1, z), (wx, wy + 1, wz), world_voxels):
                ...
                if should_render_face(voxel_id, (x + 1, y, z), (wx + 1, wy, wz), world_voxels):
                ...
                if should_render_face(voxel_id, (x, y, z - 1), (wx, wy, wz - 1), world_voxels):
